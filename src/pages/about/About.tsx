...
const About = () => {
    ...
    return (
        <div>
            <div className="about-container md:h-fit md:w-full md:pt-5 w-11/12 mx-auto pt-20 h-fit">
                <div className="content md:flex md:flex-wrap md:shadow-none shadow-custom h-fit p-5 rounded-2xl">
                    <div className="left md:w-1/2 md:flex md:justify-center hidden">
                        <img className="w-4/6 rounded-full" src={imageUrl} alt="" />
                    </div>
                    <div className="right md:w-1/2 md:p-14  my-auto">
                        <h3 className="md:text-6xl font-bold text-slate-700 text-5xl dark:text-white">About me</h3>
